...
public interface PasantiaDAO {
	...
	void create(String ubicacion, String nombre_emp, int id_alumno, String fecha) throws DAOException;

	void delete(int id_alumno) throws DAOException;

	void update(String ubicacion, String nombre_emp, int id_alumno, String fecha) throws DAOException;
