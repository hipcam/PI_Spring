...
public interface EmployeeDAO {
	...
	void create(String login, String password, String lastname, String firstname, int salary, int age, int dptId) throws DAOException;

	void delete(String login) throws DAOException;

	void update(String login, String password, String lastname, String firstname, int salary,int age,  int dptId) throws DAOException;
	...
	Employee findEmployeeByMany(String firstname, String lastname, int age) throws DAOException, EmptyResultException;
