...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public Employee findEmployee(int employee_id) throws DAOException, EmptyResultException {
		...
		String query = "SELECT employee_id, login, password, first_name, last_name, salary, age, department_id "
	...
	@Override
	public Employee findEmployeeByMany(String firstname, String lastname, int age ) throws DAOException, EmptyResultException {

		String query = "SELECT employee_id, login, password, first_name, last_name, salary, age, department_id "
				+ " FROM 4c15.employees WHERE FIRST_NAME = ? and  LAST_NAME = ? and AGE = ?";
	...
	@Override
	public void create(String login, String password, String lastname, String firstname, int salary, int age, int dptId) throws DAOException {

		String query = "INSERT INTO employees (login, password, first_name, last_name, salary, age, department_id)  VALUES ( ?,?,?,?,?,?,? )";

		Object[] params = new Object[] { login, password, lastname, firstname, salary, age, dptId };
	...
	@Override
	public void update(String  login, String password, String lastname, String firstname, int salary, int age, int dptId) throws DAOException {

		String query = "UPDATE employees SET password = ?, first_name =?, last_name = ?, salary = ?, age = ?, department_id = ? WHERE login = ?";

		Object[] params = new Object[] { password, lastname, firstname, salary, age, dptId, login };
	...
	public List<Employee> findAllEmployees() throws DAOException, EmptyResultException {
		...
		String query = "SELECT employee_id, login, password, first_name, last_name, salary, age,  department_id FROM employees ";
	...
	public Employee validate(String login, String pwd) throws LoginException, DAOException {
		...
		String query = "SELECT login, password, employee_id, first_name, last_name, salary, age, department_id  "
